            ...
            <div class="sign-right">
              ...
              <div class="contact-frm" data-aos="fade-left" method="post">
                <input
                  ...
                  value="ihlvgWVT9H5R9iTGkgmrMGV1y76sdlUXxbDqtThy5bQOcEbf25OK7MvUxcpF60fl"
                />
                ...
                <div class="field-colume inner-flex text-start text-white">
                  <div class="d-flex gap-3 align-items-center checkbox">
                    <input
                      style="width: auto"
                      type="checkbox"
                      name=""
