        ...
        <div class="row">
          <div class="col-sm-6 dn-sm">
            ...
            <div class="sign-left text-center">
              <img src="../assets/img/2fa.svg" class="img-fluid" alt="" />
            </div>
          </div>
          <div class="col-sm-6">
            ...
            <div class="col-md-12">
              <div class="sign-right">
                <h2 class="banner-heading mb-5 pb-5">
                  Email <span>Activation</span>
                </h2>
                <ul class="desc-white mt-4 mb-4 p-4">
                  <li>
                    <h1>
                ...
                <div v-else>
                  ...
                  <div class="field-colume submit-btn  text-end">

                    <button class="common-btn common-btn-block mt-4 p-4" @click="resentActivationEmail">Resend activation
                      email</button>
                  </div>
                </div>
                <template v-if="error">
