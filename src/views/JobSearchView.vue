      ...
      <div class="container">
        ...
        <div class="search-from">
          <div class="field-wapper">
            ...
            <div class="">
              ...
              <div class="search-fields">
                ...
                <div class="custom-input search-fields">
                  <select name="override_filters" class="filter-job-input-box" id="id_override_filters"
                    v-model="filters.category">
                    <option value="" selected>Filter By Categoty</option>
                    <option v-for="category in getCategories" :key="category.id" :value="category.category">
                      {{ category.category }}
                    </option>
                  </select>
                </div>
              ...
              <!-- <div class="search-fields" style="padding: inherit">
                <div class="filter">
                  <div class="custom-input experience_level_min">
                    <input type="number" name="experience_level_min" class="filter-job-input-box"
                      placeholder="Experience Min" id="id_experience_min" v-model="filters.experience_level_min"
                      min="0" />
                  </div>
                </div>
              </div> -->
              ...
              <div class="search-fields" style="padding: inherit">
                <div class="filter">
                  <div class="custom-input experience_level_max">
                    <input type="number" name="experience_level_max" class="filter-job-input-box"
                      placeholder="Experience" id="id_experience_max" v-model="filters.experience_level_max"
                      max="50" />
                  </div>
                </div>
              </div>
                ...
                <div class="filter">
                  <div class="custom-input salary_min">
                    <input type="number" name="salary_min" class="filter-job-input-box" placeholder="Salary Min"
                      id="id_Salary_min" v-model="filters.salary_min" min="0" />
                  </div>
                </div>
              </div>
              ...
              <div class="search-fields" style="padding: inherit">
                <div class="filter">
                  <div class="custom-input salary_max">
                    <input type="number" name="salary_max" class="filter-job-input-box" placeholder="Salary Max"
                ...
                <div class="filter">
                  <div class="custom-input rating_min">
                    <input type="number" name="rating_min" class="filter-job-input-box" placeholder="Rating Min"
                      id="id_rating_min" v-model="filters.rating_min" min="0" max="5" />
                  </div>
                </div>
              </div>
              ...
              <div class="search-fields" style="padding: inherit">
                <div class="filter">
                  <div class="custom-input rating_max">
                    <input type="number" name="rating_max" class="filter-job-input-box" placeholder="Rating Max"
            ...
            <br />
            <hr style="width: 45%; margin-right: 5px; display: inline-block" />
            <span style="font-weight: lighter">OR</span>
            <hr style="width: 45%;margin-left: 5px; display: inline-block" />
            <h2 class="section-heading">
          Try Our Custom <span>Filters</span>
        </h2>
            <div class="filter2">
              <div class="custom-input search-fields">
                <select name="override_filters" class="filter-job-input-box" id="id_override_filters"
                  ...
                  <option v-for="filter in overrideFilters" :key="filter.id" :value="filter.search_url">
                    {{ filter.tag_name }}
                  </option>
                </select>
              </div>
...
export default {
  ...
  computed: {
    ...
    total_count: function () {
      if (this.$store.getters.jobs_count >= 0) {
        return this.$store.getters.jobs_count;
      }
      return null;
    },
