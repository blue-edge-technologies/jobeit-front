            ...
            <div class="col-md-12">
              <div class="sign-right">
                ...
                <div v-if="page_status === PAGE_STATUS.ACTIVATING_EMAIL">
                  <div class="alert alert-info" role="alert">
                    <h1>
                      ...
                      Activating your Account...After Activaton we will redirect you to login page.
                ...
                <div v-else-if="page_status === PAGE_STATUS.REDIRECTING_TO_LOGIN">
                  <div class="alert alert-info" role="alert">
                    <h1>
                      Your Account has activated. You Will now Be Redirected to the Login Page. Please be Patient.
                      <div class="spinner-border text-primary" role="status"></div>
                    </h1>
                  </div>
                </div>
